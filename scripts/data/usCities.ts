// ============================================================
// Embedded US cities dataset — shared by import/backfill scripts.
//
// Source: SimpleMaps US Cities Database (free tier)
// Covers major cities across 36 states (population > ~10,000).
// States not covered here are still reached by state-wide
// bounding-box sweeps in the import scripts (see lib/usStates.ts).
// ============================================================
